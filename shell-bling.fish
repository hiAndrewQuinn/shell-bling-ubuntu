...
echo '- '(set_color -o blue)'Alt+E '(set_color -o yellow)' to edit your next command in '(set_color -o green)"$VISUAL"(set_color -o yellow)'.                Example @ https://andrew-quinn.me/ctrl-x-ctrl-e/'
